...
1. Total de estudantes cadastrados no banco:
2. Pessoas facilitadoras que atuam em mais de uma turma:
3. Porcentagem de estudantes com status de evasão agrupados por turma:
4. Total de estudantes que estão em cada turma e qual o curso associado a cada uma delas:
5. Informações financeiras sobre os estudantes:
6. Distribuição da carga horária de cada curso:

<img width="80%" alt="diagrama de relacionamento" src="./Model/image/graficoPBIX.png"/>
